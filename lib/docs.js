 ...
 * `edvQuery` can have these properties: `{index, equals, has}`. The `index`
 * property must be given and include an hmac ID associated with an encrypted
 * index and only one of `equals` or `has` must be given.
 *
 * @param {object} options - The options to use.
 * @param {string} options.edvId - The ID of the EDV.
